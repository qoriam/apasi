 ...
 */
define ('PDF_HEADER_LOGO', 'poliwangi.png');
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'KEMENTRIAN RISET, TEKNOLOGI, DAN PENDIDIKAN TINGGI');


/**
 * Header description string.
 */ //EMBO G ISO WEHEHEHE...
define ('PDF_HEADER_STRING', "POLITEKNIK NEGERI BANYUWANGI\nJl. Raya Jember Kilometer 13 Labanasem, Kabat, Banyuwangi, 68461\nTelepon/Faks : (0003) 6367780\nE-mail : poliwangi@poliwangi.ac.id; Website :http//www.poliwangi.ac.id\n  ");

define ('PDF_FOOTER_STRING', "AGH");
